...
//---------------------------------- VARIABLES APPLICATIVES GENERALES
	...
	#define uc_VERSION_BP_SOFT_SAVE		95			// N° de sauvegarde du soft (fichier ZIP)
	#define us_BP_VERSION_SERVEUR		34			// Version serveur a laquelle le soft va être publiée
