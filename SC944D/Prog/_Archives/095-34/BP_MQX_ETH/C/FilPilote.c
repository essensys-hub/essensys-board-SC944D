...
{
	unsigned char l_uc_Consigne_ZJ;
	unsigned char l_uc_Consigne_ZN;
	unsigned char l_uc_Consigne_SDB1;
	unsigned char l_uc_Consigne_SDB2;
	...
	TimerFilPilote_Init10ms();
	
	l_uc_Consigne_ZJ = uc_GestionChangementConsigne(uc_ConsigneFilPilotePourIT_ZJ, &uc_ConsigneFilPilotePourITPrecedent_ZJ, &uc_RAZCompteurSecondesEcoEtEcoPlus_ZJ, &uc_CompteurITModeHGForce_ZJ);
	l_uc_Consigne_ZN = uc_GestionChangementConsigne(uc_ConsigneFilPilotePourIT_ZN, &uc_ConsigneFilPilotePourITPrecedent_ZN, &uc_RAZCompteurSecondesEcoEtEcoPlus_ZN, &uc_CompteurITModeHGForce_ZN);
	l_uc_Consigne_SDB1 = uc_GestionChangementConsigne(uc_ConsigneFilPilotePourIT_SDB1, &uc_ConsigneFilPilotePourITPrecedent_SDB1, &uc_RAZCompteurSecondesEcoEtEcoPlus_SDB1, &uc_CompteurITModeHGForce_SDB1);
	l_uc_Consigne_SDB2 = uc_GestionChangementConsigne(uc_ConsigneFilPilotePourIT_SDB2, &uc_ConsigneFilPilotePourITPrecedent_SDB2, &uc_RAZCompteurSecondesEcoEtEcoPlus_SDB2, &uc_CompteurITModeHGForce_SDB2);
	
	FilPiloteZJ_PutVal(uc_PiloterSignalAlternanceNegative(l_uc_Consigne_ZJ, uc_EcoEnCours_ZJ, uc_EcoPlusEnCours_ZJ));
	FilPiloteZN_PutVal(uc_PiloterSignalAlternanceNegative(l_uc_Consigne_ZN, uc_EcoEnCours_ZN, uc_EcoPlusEnCours_ZN));
	FilPiloteSDB1_PutVal(uc_PiloterSignalAlternanceNegative(l_uc_Consigne_SDB1, uc_EcoEnCours_SDB1, uc_EcoPlusEnCours_SDB1));
	FilPiloteSDB2_PutVal(uc_PiloterSignalAlternanceNegative(l_uc_Consigne_SDB2, uc_EcoEnCours_SDB2, uc_EcoPlusEnCours_SDB2));
...
void TimerFilPilote_InitIsr(void)
{
	// Ajout routine timer (en replacement routine MQX)
	_int_install_kernel_isr(64+19, Timer10Ms_Interrupt);	// DTIM0
	_bsp_int_init(64+19, 7, 1, TRUE);
}

void TimerFilPilote_Init10ms(void)
{
...
void TimerFilPilote_Init23ms(void)
{
	clrReg16Bit(MFC_DTMR0, 0x06);	//setReg16BitGroupVal(DTMR0,CLK,0);  /* Stop counter */
...
__declspec(interrupt) void Timer10Ms_Interrupt(void)
{
	unsigned char l_uc_Consigne_ZJ;
	unsigned char l_uc_Consigne_ZN;
	unsigned char l_uc_Consigne_SDB1;
	...
	TimerFilPilote_Init23ms();

	ul_EspionCompteurITTimerAlternance++;
	...
	if(uc_DerniereITFilPiloteVue != 0)	// Derniere IT vue : FP -> faire traitement FP
	{
		...
		FilPiloteZJ_PutVal(uc_PiloterSignalAlternancePositive(l_uc_Consigne_ZJ, uc_EcoEnCours_ZJ, uc_EcoPlusEnCours_ZJ));
		FilPiloteZN_PutVal(uc_PiloterSignalAlternancePositive(l_uc_Consigne_ZN, uc_EcoEnCours_ZN, uc_EcoPlusEnCours_ZN));
		FilPiloteSDB1_PutVal(uc_PiloterSignalAlternancePositive(l_uc_Consigne_SDB1, uc_EcoEnCours_SDB1, uc_EcoPlusEnCours_SDB1));
		FilPiloteSDB2_PutVal(uc_PiloterSignalAlternancePositive(l_uc_Consigne_SDB2, uc_EcoEnCours_SDB2, uc_EcoPlusEnCours_SDB2));
