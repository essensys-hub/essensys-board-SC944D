...
//---------------------------------- VARIABLES APPLICATIVES GENERALES
	...
	#define uc_VERSION_BP_SOFT_SAVE		96			// N° de sauvegarde du soft (fichier ZIP)
	#define us_BP_VERSION_SERVEUR		35			// Version serveur a laquelle le soft va être publiée
...
//---------------------------------- GESTION TELEINFO
	...
	extern unsigned long ul_TeleinfoHCHP;
	extern unsigned long ul_TeleinfoHCHPPrecedent;
	extern unsigned short us_TeleinfoTimeOUTHCHP;				// Incrémenté sous timer TELEINFO
	#define us_TELEINFO_HCHP_APP_TIME_OUT			20			// 20 * 100 ms -> 2 secondes
...
//---------------------------------- VARIABLES ESPION RS
	...
	extern unsigned long ul_EspionCompteurITTimerAlternance;
	extern unsigned long ul_EspionCompteurITTimerAlternanceMain;
	extern unsigned long ul_EspionCompteurITTimerAlternanceMainPrecedent;
