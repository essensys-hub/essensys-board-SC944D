...
//---------------------------------- VARIABLES APPLICATIVES GENERALES
	...
	#define uc_VERSION_BP_SOFT_SAVE		97			// N° de sauvegarde du soft (fichier ZIP)
	#define us_BP_VERSION_SERVEUR		36			// Version serveur a laquelle le soft va être publiée
