	...
	for (;;)
	{
	   ...
	   //if(uc_ErreurDetectee() == 0)
	   {
		   ...
		   if(uc_SecondePrecedente != st_DateHeure.SECOND)
		   {
				...
				ul_EspionCompteurITTimerAlternanceMain = ul_EspionCompteurITTimerAlternance;
				vd_EspionRS_Printf(uc_ESPION_FIL_PILOTE,"FP IT : %d -> %d - FP TIMER : %d -> %d\n", ul_EspionCompteurITAlternanceSecteurMain, ul_EspionCompteurITAlternanceSecteurMain - ul_EspionCompteurITAlternanceSecteurMainPrecedent, ul_EspionCompteurITTimerAlternanceMain, ul_EspionCompteurITTimerAlternanceMain - ul_EspionCompteurITTimerAlternanceMainPrecedent);
				ul_EspionCompteurITAlternanceSecteurMainPrecedent = ul_EspionCompteurITAlternanceSecteurMain;
				ul_EspionCompteurITTimerAlternanceMainPrecedent = ul_EspionCompteurITTimerAlternanceMain;
